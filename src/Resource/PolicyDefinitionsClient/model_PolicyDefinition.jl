...
mutable struct PolicyDefinition <: SwaggerModel
    ...
    function PolicyDefinition(;properties=nothing, id=nothing, name=nothing, type=nothing)
        o = new()
        ...
        validate_property(PolicyDefinition, Symbol("type"), type)
        setfield!(o, Symbol("type"), type)
        o
    end
end # type PolicyDefinition

const _property_map_PolicyDefinition = Dict{Symbol,Symbol}(Symbol("properties")=>Symbol("properties"), Symbol("id")=>Symbol("id"), Symbol("name")=>Symbol("name"), Symbol("type")=>Symbol("type"))
...
Swagger.property_type(::Type{ PolicyDefinition }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_PolicyDefinition[name]))}
