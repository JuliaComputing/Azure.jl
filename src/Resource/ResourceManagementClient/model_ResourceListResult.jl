...
mutable struct ResourceListResult <: SwaggerModel
    value::Any # spec type: Union{ Nothing, Vector{GenericResourceExpanded} } # spec name: value
...
Swagger.property_type(::Type{ ResourceListResult }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ResourceListResult[name]))}
