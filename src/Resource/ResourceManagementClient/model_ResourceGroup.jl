...
mutable struct ResourceGroup <: SwaggerModel
    ...
    function ResourceGroup(;id=nothing, name=nothing, type=nothing, properties=nothing, location=nothing, managedBy=nothing, tags=nothing)
        o = new()
        validate_property(ResourceGroup, Symbol("id"), id)
        setfield!(o, Symbol("id"), id)
        validate_property(ResourceGroup, Symbol("name"), name)
        setfield!(o, Symbol("name"), name)
        validate_property(ResourceGroup, Symbol("type"), type)
...
const _property_map_ResourceGroup = Dict{Symbol,Symbol}(Symbol("id")=>Symbol("id"), Symbol("name")=>Symbol("name"), Symbol("type")=>Symbol("type"), Symbol("properties")=>Symbol("properties"), Symbol("location")=>Symbol("location"), Symbol("managedBy")=>Symbol("managedBy"), Symbol("tags")=>Symbol("tags"))
...
Swagger.property_type(::Type{ ResourceGroup }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ResourceGroup[name]))}
