...
mutable struct ProviderResourceType <: SwaggerModel
    ...
    aliases::Any # spec type: Union{ Nothing, Vector{Alias} } # spec name: aliases
    apiVersions::Any # spec type: Union{ Nothing, Vector{String} } # spec name: apiVersions
    capabilities::Any # spec type: Union{ Nothing, String } # spec name: capabilities
    properties::Any # spec type: Union{ Nothing, Dict{String, String} } # spec name: properties

    function ProviderResourceType(;resourceType=nothing, locations=nothing, aliases=nothing, apiVersions=nothing, capabilities=nothing, properties=nothing)
        o = new()
        ...
        validate_property(ProviderResourceType, Symbol("capabilities"), capabilities)
...
const _property_map_ProviderResourceType = Dict{Symbol,Symbol}(Symbol("resourceType")=>Symbol("resourceType"), Symbol("locations")=>Symbol("locations"), Symbol("aliases")=>Symbol("aliases"), Symbol("apiVersions")=>Symbol("apiVersions"), Symbol("capabilities")=>Symbol("capabilities"), Symbol("properties")=>Symbol("properties"))
...
Swagger.property_type(::Type{ ProviderResourceType }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ProviderResourceType[name]))}
