...
mutable struct Plan <: SwaggerModel
    ...
    function Plan(;name=nothing, publisher=nothing, product=nothing, promotionCode=nothing, version=nothing)
        o = new()
        ...
        validate_property(Plan, Symbol("version"), version)
        setfield!(o, Symbol("version"), version)
        o
    end
end # type Plan

const _property_map_Plan = Dict{Symbol,Symbol}(Symbol("name")=>Symbol("name"), Symbol("publisher")=>Symbol("publisher"), Symbol("product")=>Symbol("product"), Symbol("promotionCode")=>Symbol("promotionCode"), Symbol("version")=>Symbol("version"))
