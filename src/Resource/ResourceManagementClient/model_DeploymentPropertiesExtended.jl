...
type DeploymentPropertiesExtended <: SwaggerModel
    provisioningState::Nullable{ String } # provisioningState
    correlationId::Nullable{ String } # correlationId
    timestamp::Nullable{ DateTime } # timestamp
    outputs::Nullable{ Any } # outputs
    providers::Nullable{ Vector{Provider} } # providers
    dependencies::Nullable{ Vector{Dependency} } # dependencies
    template::Nullable{ Any } # template
    templateLink::Nullable{ TemplateLink } # templateLink
    parameters::Nullable{ Any } # parameters
    parametersLink::Nullable{ ParametersLink } # parametersLink
    mode::Nullable{ String } # mode
    debugSetting::Nullable{ DebugSetting } # debugSetting
