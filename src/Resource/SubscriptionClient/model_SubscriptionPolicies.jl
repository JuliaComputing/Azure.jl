...
type SubscriptionPolicies <: SwaggerModel
    locationPlacementId::Nullable{ String } # locationPlacementId
    quotaId::Nullable{ String } # quotaId
    spendingLimit::Nullable{ String } # spendingLimit
