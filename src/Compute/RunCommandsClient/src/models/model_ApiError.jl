...
Base.@kwdef mutable struct ApiError <: OpenAPI.APIModel
    ...
    function ApiError(details, innererror, code, target, message, )
        o = new(details, innererror, code, target, message, )
...
function OpenAPI.check_required(o::ApiError)
    true
end

function OpenAPI.validate_properties(o::ApiError)
    OpenAPI.validate_property(ApiError, Symbol("details"), o.details)
    OpenAPI.validate_property(ApiError, Symbol("innererror"), o.innererror)
    OpenAPI.validate_property(ApiError, Symbol("code"), o.code)
    OpenAPI.validate_property(ApiError, Symbol("target"), o.target)
    OpenAPI.validate_property(ApiError, Symbol("message"), o.message)
end
