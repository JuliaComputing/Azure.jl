...
type DiskProperties <: SwaggerModel
    timeCreated::Nullable{ DateTime } # timeCreated
    osType::Nullable{ String } # osType
    creationData::Nullable{ CreationData } # creationData
...
function check_required(o::DiskProperties)
    isnull(o.creationData) && (return false)
    true
end
