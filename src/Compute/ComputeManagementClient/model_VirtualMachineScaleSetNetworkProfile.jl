...
mutable struct VirtualMachineScaleSetNetworkProfile <: SwaggerModel
    healthProbe::Union{ Nothing, ApiEntityReference } # healthProbe
    networkInterfaceConfigurations::Union{ Nothing, Vector{VirtualMachineScaleSetNetworkConfiguration} } # networkInterfaceConfigurations
