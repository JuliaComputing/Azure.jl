...
type BootDiagnosticsInstanceView <: SwaggerModel
    consoleScreenshotBlobUri::Nullable{ String } # consoleScreenshotBlobUri
    serialConsoleLogBlobUri::Nullable{ String } # serialConsoleLogBlobUri
