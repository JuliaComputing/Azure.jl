...
mutable struct ImageProperties <: SwaggerModel
    ...
    function ImageProperties(;sourceVirtualMachine=nothing, storageProfile=nothing, provisioningState=nothing, hyperVGeneration=nothing)
        o = new()
        ...
        validate_property(ImageProperties, Symbol("hyperVGeneration"), hyperVGeneration)
        setfield!(o, Symbol("hyperVGeneration"), hyperVGeneration)
        o
    end
end # type ImageProperties

const _property_map_ImageProperties = Dict{Symbol,Symbol}(Symbol("sourceVirtualMachine")=>Symbol("sourceVirtualMachine"), Symbol("storageProfile")=>Symbol("storageProfile"), Symbol("provisioningState")=>Symbol("provisioningState"), Symbol("hyperVGeneration")=>Symbol("hyperVGeneration"))
...
Swagger.property_type(::Type{ ImageProperties }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ImageProperties[name]))}
