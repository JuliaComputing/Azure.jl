...
Swagger.property_type(::Type{ VirtualMachineScaleSetPublicIPAddressConfiguration }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualMachineScaleSetPublicIPAddressConfiguration[name]))}
