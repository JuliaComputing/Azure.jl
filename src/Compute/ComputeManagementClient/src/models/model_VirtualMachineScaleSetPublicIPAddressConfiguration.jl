...
Base.@kwdef mutable struct VirtualMachineScaleSetPublicIPAddressConfiguration <: OpenAPI.APIModel
    ...
    function VirtualMachineScaleSetPublicIPAddressConfiguration(name, properties, sku, )
...
const _property_types_VirtualMachineScaleSetPublicIPAddressConfiguration = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("properties")=>"VirtualMachineScaleSetPublicIPAddressConfigurationProperties", Symbol("sku")=>"PublicIPAddressSku", )
...
function OpenAPI.validate_properties(o::VirtualMachineScaleSetPublicIPAddressConfiguration)
    OpenAPI.validate_property(VirtualMachineScaleSetPublicIPAddressConfiguration, Symbol("name"), o.name)
    OpenAPI.validate_property(VirtualMachineScaleSetPublicIPAddressConfiguration, Symbol("properties"), o.properties)
    OpenAPI.validate_property(VirtualMachineScaleSetPublicIPAddressConfiguration, Symbol("sku"), o.sku)
end
