...
Describes the properties of an AssessPatches result.
    ...
    - availablePatches::Vector{VirtualMachineSoftwarePatchProperties} : The list of patches that have been detected as available for installation.
    - error::ApiError
"""
Base.@kwdef mutable struct VirtualMachineAssessPatchesResult <: OpenAPI.APIModel
    ...
    availablePatches::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{VirtualMachineSoftwarePatchProperties} }
    error = nothing # spec type: Union{ Nothing, ApiError }

    function VirtualMachineAssessPatchesResult(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, startDateTime, availablePatches, error, )
        o = new(status, assessmentActivityId, rebootPending, criticalAndSecurityPatchCount, otherPatchCount, startDateTime, availablePatches, error, )
        OpenAPI.validate_properties(o)
        return o
    end
end # type VirtualMachineAssessPatchesResult

const _property_types_VirtualMachineAssessPatchesResult = Dict{Symbol,String}(Symbol("status")=>"String", Symbol("assessmentActivityId")=>"String", Symbol("rebootPending")=>"Bool", Symbol("criticalAndSecurityPatchCount")=>"Int64", Symbol("otherPatchCount")=>"Int64", Symbol("startDateTime")=>"ZonedDateTime", Symbol("availablePatches")=>"Vector{VirtualMachineSoftwarePatchProperties}", Symbol("error")=>"ApiError", )
...
function OpenAPI.check_required(o::VirtualMachineAssessPatchesResult)
    true
end

function OpenAPI.validate_properties(o::VirtualMachineAssessPatchesResult)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("status"), o.status)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("assessmentActivityId"), o.assessmentActivityId)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("rebootPending"), o.rebootPending)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("criticalAndSecurityPatchCount"), o.criticalAndSecurityPatchCount)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("otherPatchCount"), o.otherPatchCount)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("startDateTime"), o.startDateTime)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("availablePatches"), o.availablePatches)
    OpenAPI.validate_property(VirtualMachineAssessPatchesResult, Symbol("error"), o.error)
end

function OpenAPI.validate_property(::Type{ VirtualMachineAssessPatchesResult }, name::Symbol, val)

    if name === Symbol("status")
        OpenAPI.validate_param(name, "VirtualMachineAssessPatchesResult", :enum, val, ["Unknown", "InProgress", "Failed", "Succeeded", "CompletedWithWarnings"])
    end
