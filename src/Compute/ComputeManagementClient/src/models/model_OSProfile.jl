...
Base.@kwdef mutable struct OSProfile <: OpenAPI.APIModel
    ...
    function OSProfile(computerName, adminUsername, adminPassword, customData, windowsConfiguration, linuxConfiguration, secrets, allowExtensionOperations, requireGuestProvisionSignal, )
        o = new(computerName, adminUsername, adminPassword, customData, windowsConfiguration, linuxConfiguration, secrets, allowExtensionOperations, requireGuestProvisionSignal, )
...
function OpenAPI.check_required(o::OSProfile)
    true
end

function OpenAPI.validate_properties(o::OSProfile)
    OpenAPI.validate_property(OSProfile, Symbol("computerName"), o.computerName)
    OpenAPI.validate_property(OSProfile, Symbol("adminUsername"), o.adminUsername)
    OpenAPI.validate_property(OSProfile, Symbol("adminPassword"), o.adminPassword)
    OpenAPI.validate_property(OSProfile, Symbol("customData"), o.customData)
    OpenAPI.validate_property(OSProfile, Symbol("windowsConfiguration"), o.windowsConfiguration)
    OpenAPI.validate_property(OSProfile, Symbol("linuxConfiguration"), o.linuxConfiguration)
    OpenAPI.validate_property(OSProfile, Symbol("secrets"), o.secrets)
    OpenAPI.validate_property(OSProfile, Symbol("allowExtensionOperations"), o.allowExtensionOperations)
    OpenAPI.validate_property(OSProfile, Symbol("requireGuestProvisionSignal"), o.requireGuestProvisionSignal)
end
