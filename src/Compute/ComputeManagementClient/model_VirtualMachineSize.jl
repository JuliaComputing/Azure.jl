...
mutable struct VirtualMachineSize <: SwaggerModel
    ...
    numberOfCores::Union{ Nothing, Int32 } # numberOfCores
    osDiskSizeInMB::Union{ Nothing, Int32 } # osDiskSizeInMB
    resourceDiskSizeInMB::Union{ Nothing, Int32 } # resourceDiskSizeInMB
    memoryInMB::Union{ Nothing, Int32 } # memoryInMB
    maxDataDiskCount::Union{ Nothing, Int32 } # maxDataDiskCount
