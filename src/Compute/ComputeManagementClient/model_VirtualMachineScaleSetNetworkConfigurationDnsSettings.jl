...
Swagger.property_type(::Type{ VirtualMachineScaleSetNetworkConfigurationDnsSettings }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualMachineScaleSetNetworkConfigurationDnsSettings[name]))}
