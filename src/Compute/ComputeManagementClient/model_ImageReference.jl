...
mutable struct ImageReference <: SwaggerModel
    ...
    exactVersion::Any # spec type: Union{ Nothing, String } # spec name: exactVersion

    function ImageReference(;id=nothing, publisher=nothing, offer=nothing, sku=nothing, version=nothing, exactVersion=nothing)
        o = new()
        ...
        validate_property(ImageReference, Symbol("exactVersion"), exactVersion)
        setfield!(o, Symbol("exactVersion"), exactVersion)
        o
    end
end # type ImageReference

const _property_map_ImageReference = Dict{Symbol,Symbol}(Symbol("id")=>Symbol("id"), Symbol("publisher")=>Symbol("publisher"), Symbol("offer")=>Symbol("offer"), Symbol("sku")=>Symbol("sku"), Symbol("version")=>Symbol("version"), Symbol("exactVersion")=>Symbol("exactVersion"))
...
Swagger.property_type(::Type{ ImageReference }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ImageReference[name]))}
