...
Swagger.property_type(::Type{ VirtualMachineScaleSetInstanceViewStatusesSummary }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualMachineScaleSetInstanceViewStatusesSummary[name]))}
