...
mutable struct VirtualMachineScaleSetDataDisk <: SwaggerModel
    ...
    function VirtualMachineScaleSetDataDisk(;name=nothing, lun=nothing, caching=nothing, writeAcceleratorEnabled=nothing, createOption=nothing, diskSizeGB=nothing, managedDisk=nothing, diskIOPSReadWrite=nothing, diskMBpsReadWrite=nothing)
        o = new()
        ...
        validate_property(VirtualMachineScaleSetDataDisk, Symbol("writeAcceleratorEnabled"), writeAcceleratorEnabled)
        ...
        validate_property(VirtualMachineScaleSetDataDisk, Symbol("diskIOPSReadWrite"), diskIOPSReadWrite)
        setfield!(o, Symbol("diskIOPSReadWrite"), diskIOPSReadWrite)
        validate_property(VirtualMachineScaleSetDataDisk, Symbol("diskMBpsReadWrite"), diskMBpsReadWrite)
        setfield!(o, Symbol("diskMBpsReadWrite"), diskMBpsReadWrite)
        o
    end
end # type VirtualMachineScaleSetDataDisk

const _property_map_VirtualMachineScaleSetDataDisk = Dict{Symbol,Symbol}(Symbol("name")=>Symbol("name"), Symbol("lun")=>Symbol("lun"), Symbol("caching")=>Symbol("caching"), Symbol("writeAcceleratorEnabled")=>Symbol("writeAcceleratorEnabled"), Symbol("createOption")=>Symbol("createOption"), Symbol("diskSizeGB")=>Symbol("diskSizeGB"), Symbol("managedDisk")=>Symbol("managedDisk"), Symbol("diskIOPSReadWrite")=>Symbol("diskIOPSReadWrite"), Symbol("diskMBpsReadWrite")=>Symbol("diskMBpsReadWrite"))
const _property_types_VirtualMachineScaleSetDataDisk = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("lun")=>"Int32", Symbol("caching")=>"Caching", Symbol("writeAcceleratorEnabled")=>"Bool", Symbol("createOption")=>"CreateOption", Symbol("diskSizeGB")=>"Int32", Symbol("managedDisk")=>"VirtualMachineScaleSetManagedDiskParameters", Symbol("diskIOPSReadWrite")=>"Int64", Symbol("diskMBpsReadWrite")=>"Int64")
Base.propertynames(::Type{ VirtualMachineScaleSetDataDisk }) = collect(keys(_property_map_VirtualMachineScaleSetDataDisk))
Swagger.property_type(::Type{ VirtualMachineScaleSetDataDisk }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualMachineScaleSetDataDisk[name]))}
