...
mutable struct VirtualMachineScaleSetUpdateOSDisk <: SwaggerModel
    ...
    function VirtualMachineScaleSetUpdateOSDisk(;caching=nothing, writeAcceleratorEnabled=nothing, diskSizeGB=nothing, image=nothing, vhdContainers=nothing, managedDisk=nothing)
        o = new()
        validate_property(VirtualMachineScaleSetUpdateOSDisk, Symbol("caching"), caching)
        setfield!(o, Symbol("caching"), caching)
        validate_property(VirtualMachineScaleSetUpdateOSDisk, Symbol("writeAcceleratorEnabled"), writeAcceleratorEnabled)
        setfield!(o, Symbol("writeAcceleratorEnabled"), writeAcceleratorEnabled)
        validate_property(VirtualMachineScaleSetUpdateOSDisk, Symbol("diskSizeGB"), diskSizeGB)
...
const _property_map_VirtualMachineScaleSetUpdateOSDisk = Dict{Symbol,Symbol}(Symbol("caching")=>Symbol("caching"), Symbol("writeAcceleratorEnabled")=>Symbol("writeAcceleratorEnabled"), Symbol("diskSizeGB")=>Symbol("diskSizeGB"), Symbol("image")=>Symbol("image"), Symbol("vhdContainers")=>Symbol("vhdContainers"), Symbol("managedDisk")=>Symbol("managedDisk"))
const _property_types_VirtualMachineScaleSetUpdateOSDisk = Dict{Symbol,String}(Symbol("caching")=>"Caching", Symbol("writeAcceleratorEnabled")=>"Bool", Symbol("diskSizeGB")=>"Int32", Symbol("image")=>"VirtualHardDisk", Symbol("vhdContainers")=>"Vector{String}", Symbol("managedDisk")=>"VirtualMachineScaleSetManagedDiskParameters")
Base.propertynames(::Type{ VirtualMachineScaleSetUpdateOSDisk }) = collect(keys(_property_map_VirtualMachineScaleSetUpdateOSDisk))
Swagger.property_type(::Type{ VirtualMachineScaleSetUpdateOSDisk }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualMachineScaleSetUpdateOSDisk[name]))}
