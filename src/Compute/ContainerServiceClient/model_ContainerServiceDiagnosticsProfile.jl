...
Swagger.property_type(::Type{ ContainerServiceDiagnosticsProfile }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ContainerServiceDiagnosticsProfile[name]))}
