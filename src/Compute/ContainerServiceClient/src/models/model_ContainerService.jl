...
function OpenAPI.check_required(o::ContainerService)
    o.location === nothing && (return false)
    true
end

function OpenAPI.validate_properties(o::ContainerService)
    OpenAPI.validate_property(ContainerService, Symbol("properties"), o.properties)
    OpenAPI.validate_property(ContainerService, Symbol("id"), o.id)
    OpenAPI.validate_property(ContainerService, Symbol("name"), o.name)
    OpenAPI.validate_property(ContainerService, Symbol("type"), o.type)
    OpenAPI.validate_property(ContainerService, Symbol("location"), o.location)
    OpenAPI.validate_property(ContainerService, Symbol("tags"), o.tags)
end
