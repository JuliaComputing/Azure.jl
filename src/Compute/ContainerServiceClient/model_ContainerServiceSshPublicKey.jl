...
Swagger.property_type(::Type{ ContainerServiceSshPublicKey }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ContainerServiceSshPublicKey[name]))}
