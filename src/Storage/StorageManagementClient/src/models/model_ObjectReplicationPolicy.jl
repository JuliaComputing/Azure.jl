...
function OpenAPI.check_required(o::ObjectReplicationPolicy)
    true
end

function OpenAPI.validate_properties(o::ObjectReplicationPolicy)
    OpenAPI.validate_property(ObjectReplicationPolicy, Symbol("properties"), o.properties)
    OpenAPI.validate_property(ObjectReplicationPolicy, Symbol("id"), o.id)
    OpenAPI.validate_property(ObjectReplicationPolicy, Symbol("name"), o.name)
    OpenAPI.validate_property(ObjectReplicationPolicy, Symbol("type"), o.type)
end
