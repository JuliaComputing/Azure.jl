...
function OpenAPI.check_required(o::ManagementPolicyProperties)
    o.policy === nothing && (return false)
    true
end

function OpenAPI.validate_properties(o::ManagementPolicyProperties)
    OpenAPI.validate_property(ManagementPolicyProperties, Symbol("lastModifiedTime"), o.lastModifiedTime)
    OpenAPI.validate_property(ManagementPolicyProperties, Symbol("policy"), o.policy)
end
