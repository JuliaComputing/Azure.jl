...
mutable struct Encryption <: SwaggerModel
    services::Union{ Nothing, EncryptionServices } # services
    keySource::Union{ Nothing, String } # keySource
    keyvaultproperties::Union{ Nothing, KeyVaultProperties } # keyvaultproperties
