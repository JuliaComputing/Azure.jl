...
mutable struct StorageAccount <: SwaggerModel
    ...
    function StorageAccount(;tags=nothing, location=nothing, id=nothing, name=nothing, type=nothing)
        o = new()
...
const _property_map_StorageAccount = Dict{Symbol,Symbol}(Symbol("tags")=>Symbol("tags"), Symbol("location")=>Symbol("location"), Symbol("id")=>Symbol("id"), Symbol("name")=>Symbol("name"), Symbol("type")=>Symbol("type"))
const _property_types_StorageAccount = Dict{Symbol,String}(Symbol("tags")=>"Dict{String, String}", Symbol("location")=>"String", Symbol("id")=>"String", Symbol("name")=>"String", Symbol("type")=>"String")
