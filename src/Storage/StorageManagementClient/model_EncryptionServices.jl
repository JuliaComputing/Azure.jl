...
type EncryptionServices <: SwaggerModel
    blob::Nullable{ EncryptionService } # blob
    file::Nullable{ EncryptionService } # file
    table::Nullable{ EncryptionService } # table
    queue::Nullable{ EncryptionService } # queue
