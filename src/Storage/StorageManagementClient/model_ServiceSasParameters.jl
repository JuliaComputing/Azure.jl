...
type ServiceSasParameters <: SwaggerModel
    canonicalizedResource::Nullable{ String } # canonicalizedResource
    signedResource::Nullable{ String } # signedResource
    ...
    signedIdentifier::Nullable{ String } # signedIdentifier
    startPk::Nullable{ String } # startPk
    endPk::Nullable{ String } # endPk
    startRk::Nullable{ String } # startRk
    endRk::Nullable{ String } # endRk
    keyToSign::Nullable{ String } # keyToSign
    rscc::Nullable{ String } # rscc
    rscd::Nullable{ String } # rscd
    rsce::Nullable{ String } # rsce
    rscl::Nullable{ String } # rscl
    rsct::Nullable{ String } # rsct
...
function check_required(o::ServiceSasParameters)
    isnull(o.canonicalizedResource) && (return false)
    true
end
