...
mutable struct Usage <: SwaggerModel
    ...
    limit::Any # spec type: Union{ Nothing, Int32 } # spec name: limit
    name::Any # spec type: Union{ Nothing, UsageName } # spec name: name

    function Usage(;unit=nothing, id=nothing, currentValue=nothing, limit=nothing, name=nothing)
        o = new()
        validate_property(Usage, Symbol("unit"), unit)
        setfield!(o, Symbol("unit"), unit)
        validate_property(Usage, Symbol("id"), id)
...
const _property_map_Usage = Dict{Symbol,Symbol}(Symbol("unit")=>Symbol("unit"), Symbol("id")=>Symbol("id"), Symbol("currentValue")=>Symbol("currentValue"), Symbol("limit")=>Symbol("limit"), Symbol("name")=>Symbol("name"))
const _property_types_Usage = Dict{Symbol,String}(Symbol("unit")=>"String", Symbol("id")=>"String", Symbol("currentValue")=>"Int32", Symbol("limit")=>"Int32", Symbol("name")=>"UsageName")
