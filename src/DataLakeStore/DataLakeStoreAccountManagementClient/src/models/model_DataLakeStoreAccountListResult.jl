...
function OpenAPI.check_required(o::DataLakeStoreAccountListResult)
    true
end

function OpenAPI.validate_properties(o::DataLakeStoreAccountListResult)
    OpenAPI.validate_property(DataLakeStoreAccountListResult, Symbol("value"), o.value)
    OpenAPI.validate_property(DataLakeStoreAccountListResult, Symbol("nextLink"), o.nextLink)
end
