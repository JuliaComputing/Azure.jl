...
Swagger.property_type(::Type{ NameAvailabilityInformation }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_NameAvailabilityInformation[name]))}
