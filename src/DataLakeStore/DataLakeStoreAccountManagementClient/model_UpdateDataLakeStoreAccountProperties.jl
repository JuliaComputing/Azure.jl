...
mutable struct UpdateDataLakeStoreAccountProperties <: SwaggerModel
    firewallState::Union{ Nothing, String } # firewallState
    trustedIdProviderState::Union{ Nothing, String } # trustedIdProviderState
    defaultGroup::Union{ Nothing, String } # defaultGroup
    newTier::Union{ Nothing, String } # newTier
    firewallAllowAzureIps::Union{ Nothing, String } # firewallAllowAzureIps
    encryptionConfig::Union{ Nothing, UpdateEncryptionConfig } # encryptionConfig
