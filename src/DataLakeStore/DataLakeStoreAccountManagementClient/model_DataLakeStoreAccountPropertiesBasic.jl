...
mutable struct DataLakeStoreAccountPropertiesBasic <: SwaggerModel
    ...
    function DataLakeStoreAccountPropertiesBasic(;accountId=nothing, provisioningState=nothing, state=nothing, creationTime=nothing, lastModifiedTime=nothing, endpoint=nothing)
        o = new()
...
const _property_map_DataLakeStoreAccountPropertiesBasic = Dict{Symbol,Symbol}(Symbol("accountId")=>Symbol("accountId"), Symbol("provisioningState")=>Symbol("provisioningState"), Symbol("state")=>Symbol("state"), Symbol("creationTime")=>Symbol("creationTime"), Symbol("lastModifiedTime")=>Symbol("lastModifiedTime"), Symbol("endpoint")=>Symbol("endpoint"))
const _property_types_DataLakeStoreAccountPropertiesBasic = Dict{Symbol,String}(Symbol("accountId")=>"String", Symbol("provisioningState")=>"String", Symbol("state")=>"String", Symbol("creationTime")=>"DateTime", Symbol("lastModifiedTime")=>"DateTime", Symbol("endpoint")=>"String")
...
Swagger.property_type(::Type{ DataLakeStoreAccountPropertiesBasic }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_DataLakeStoreAccountPropertiesBasic[name]))}
