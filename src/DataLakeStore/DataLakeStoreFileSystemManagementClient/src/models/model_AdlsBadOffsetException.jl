...
Base.@kwdef mutable struct AdlsBadOffsetException <: OpenAPI.APIModel
    ...
    function AdlsBadOffsetException(exception, javaClassName, message, )
        OpenAPI.validate_property(AdlsBadOffsetException, Symbol("exception"), exception)
        OpenAPI.validate_property(AdlsBadOffsetException, Symbol("javaClassName"), javaClassName)
        OpenAPI.validate_property(AdlsBadOffsetException, Symbol("message"), message)
