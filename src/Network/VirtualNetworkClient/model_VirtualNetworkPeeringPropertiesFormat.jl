...
mutable struct VirtualNetworkPeeringPropertiesFormat <: SwaggerModel
    ...
    remoteAddressSpace::Any # spec type: Union{ Nothing, AddressSpace } # spec name: remoteAddressSpace
    peeringState::Any # spec type: Union{ Nothing, String } # spec name: peeringState
    provisioningState::Any # spec type: Union{ Nothing, ProvisioningState } # spec name: provisioningState

    function VirtualNetworkPeeringPropertiesFormat(;allowVirtualNetworkAccess=nothing, allowForwardedTraffic=nothing, allowGatewayTransit=nothing, useRemoteGateways=nothing, remoteVirtualNetwork=nothing, remoteAddressSpace=nothing, peeringState=nothing, provisioningState=nothing)
        o = new()
        ...
        validate_property(VirtualNetworkPeeringPropertiesFormat, Symbol("remoteAddressSpace"), remoteAddressSpace)
        setfield!(o, Symbol("remoteAddressSpace"), remoteAddressSpace)
...
const _property_map_VirtualNetworkPeeringPropertiesFormat = Dict{Symbol,Symbol}(Symbol("allowVirtualNetworkAccess")=>Symbol("allowVirtualNetworkAccess"), Symbol("allowForwardedTraffic")=>Symbol("allowForwardedTraffic"), Symbol("allowGatewayTransit")=>Symbol("allowGatewayTransit"), Symbol("useRemoteGateways")=>Symbol("useRemoteGateways"), Symbol("remoteVirtualNetwork")=>Symbol("remoteVirtualNetwork"), Symbol("remoteAddressSpace")=>Symbol("remoteAddressSpace"), Symbol("peeringState")=>Symbol("peeringState"), Symbol("provisioningState")=>Symbol("provisioningState"))
...
Swagger.property_type(::Type{ VirtualNetworkPeeringPropertiesFormat }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_VirtualNetworkPeeringPropertiesFormat[name]))}
