...
const _property_types_PrivateLinkServiceIpConfigurationProperties = Dict{Symbol,String}(Symbol("privateIPAddress")=>"String", Symbol("privateIPAllocationMethod")=>"IPAllocationMethod", Symbol("subnet")=>"Subnet2", Symbol("primary")=>"Bool", Symbol("provisioningState")=>"ProvisioningState", Symbol("privateIPAddressVersion")=>"IPVersion", )
