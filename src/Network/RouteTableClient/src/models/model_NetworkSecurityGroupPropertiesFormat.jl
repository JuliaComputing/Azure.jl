...
const _property_types_NetworkSecurityGroupPropertiesFormat = Dict{Symbol,String}(Symbol("flushConnection")=>"Bool", Symbol("securityRules")=>"Vector{SecurityRule}", Symbol("defaultSecurityRules")=>"Vector{SecurityRule}", Symbol("networkInterfaces")=>"Vector{NetworkInterface}", Symbol("subnets")=>"Vector{Subnet}", Symbol("flowLogs")=>"Vector{FlowLog}", Symbol("resourceGuid")=>"String", Symbol("provisioningState")=>"ProvisioningState", )
