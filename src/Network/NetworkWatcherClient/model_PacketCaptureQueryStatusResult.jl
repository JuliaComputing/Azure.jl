...
type PacketCaptureQueryStatusResult <: SwaggerModel
    name::Nullable{ String } # name
    id::Nullable{ String } # id
    captureStartTime::Nullable{ DateTime } # captureStartTime
    packetCaptureStatus::Nullable{ String } # packetCaptureStatus
    stopReason::Nullable{ String } # stopReason
    packetCaptureError::Nullable{ Vector{String} } # packetCaptureError
