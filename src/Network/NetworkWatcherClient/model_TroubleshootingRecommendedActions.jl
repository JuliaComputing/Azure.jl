...
type TroubleshootingRecommendedActions <: SwaggerModel
    actionId::Nullable{ String } # actionId
    actionText::Nullable{ String } # actionText
    actionUri::Nullable{ String } # actionUri
    actionUriText::Nullable{ String } # actionUriText
