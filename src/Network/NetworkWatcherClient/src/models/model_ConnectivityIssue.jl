...
function OpenAPI.check_required(o::ConnectivityIssue)
    true
end

function OpenAPI.validate_properties(o::ConnectivityIssue)
    OpenAPI.validate_property(ConnectivityIssue, Symbol("origin"), o.origin)
    OpenAPI.validate_property(ConnectivityIssue, Symbol("severity"), o.severity)
    OpenAPI.validate_property(ConnectivityIssue, Symbol("type"), o.type)
    OpenAPI.validate_property(ConnectivityIssue, Symbol("context"), o.context)
end
