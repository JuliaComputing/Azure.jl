...
mutable struct FlowLogProperties <: SwaggerModel
    ...
    function FlowLogProperties(;storageId=nothing, enabled=nothing, retentionPolicy=nothing, format=nothing)
        o = new()
        ...
        validate_property(FlowLogProperties, Symbol("format"), format)
        setfield!(o, Symbol("format"), format)
        o
    end
end # type FlowLogProperties

const _property_map_FlowLogProperties = Dict{Symbol,Symbol}(Symbol("storageId")=>Symbol("storageId"), Symbol("enabled")=>Symbol("enabled"), Symbol("retentionPolicy")=>Symbol("retentionPolicy"), Symbol("format")=>Symbol("format"))
...
Swagger.property_type(::Type{ FlowLogProperties }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_FlowLogProperties[name]))}
