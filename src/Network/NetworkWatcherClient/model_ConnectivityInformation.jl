...
mutable struct ConnectivityInformation <: SwaggerModel
    hops::Union{ Nothing, Vector{ConnectivityHop} } # hops
    connectionStatus::Union{ Nothing, String } # connectionStatus
    avgLatencyInMs::Union{ Nothing, Int32 } # avgLatencyInMs
    minLatencyInMs::Union{ Nothing, Int32 } # minLatencyInMs
    maxLatencyInMs::Union{ Nothing, Int32 } # maxLatencyInMs
    probesSent::Union{ Nothing, Int32 } # probesSent
    probesFailed::Union{ Nothing, Int32 } # probesFailed
