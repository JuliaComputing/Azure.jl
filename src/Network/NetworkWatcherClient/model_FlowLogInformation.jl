...
mutable struct FlowLogInformation <: SwaggerModel
    ...
    function FlowLogInformation(;targetResourceId=nothing, properties=nothing, flowAnalyticsConfiguration=nothing)
        o = new()
        ...
        validate_property(FlowLogInformation, Symbol("flowAnalyticsConfiguration"), flowAnalyticsConfiguration)
        setfield!(o, Symbol("flowAnalyticsConfiguration"), flowAnalyticsConfiguration)
        o
    end
end # type FlowLogInformation

const _property_map_FlowLogInformation = Dict{Symbol,Symbol}(Symbol("targetResourceId")=>Symbol("targetResourceId"), Symbol("properties")=>Symbol("properties"), Symbol("flowAnalyticsConfiguration")=>Symbol("flowAnalyticsConfiguration"))
...
Swagger.property_type(::Type{ FlowLogInformation }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_FlowLogInformation[name]))}
