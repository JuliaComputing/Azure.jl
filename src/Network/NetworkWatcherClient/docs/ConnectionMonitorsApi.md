...
**connection_monitor_name** | **String** | The name of the connection monitor. |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **migrate** | **String** | Value indicating whether connection monitor V1 should be migrated to V2 format. | [default to nothing]
