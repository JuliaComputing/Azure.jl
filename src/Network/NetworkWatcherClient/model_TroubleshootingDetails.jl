...
type TroubleshootingDetails <: SwaggerModel
    id::Nullable{ String } # id
    reasonType::Nullable{ String } # reasonType
    summary::Nullable{ String } # summary
    detail::Nullable{ String } # detail
    recommendedActions::Nullable{ Vector{TroubleshootingRecommendedActions} } # recommendedActions
