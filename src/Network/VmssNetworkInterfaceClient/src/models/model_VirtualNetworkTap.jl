...
function OpenAPI.check_required(o::VirtualNetworkTap)
    true
end

function OpenAPI.validate_properties(o::VirtualNetworkTap)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("properties"), o.properties)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("etag"), o.etag)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("id"), o.id)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("name"), o.name)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("type"), o.type)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("location"), o.location)
    OpenAPI.validate_property(VirtualNetworkTap, Symbol("tags"), o.tags)
end
