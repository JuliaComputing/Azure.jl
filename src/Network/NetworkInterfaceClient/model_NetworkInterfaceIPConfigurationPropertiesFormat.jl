...
mutable struct NetworkInterfaceIPConfigurationPropertiesFormat <: SwaggerModel
    applicationGatewayBackendAddressPools::Union{ Nothing, Vector{ApplicationGatewayBackendAddressPool} } # applicationGatewayBackendAddressPools
    loadBalancerBackendAddressPools::Union{ Nothing, Vector{BackendAddressPool} } # loadBalancerBackendAddressPools
    loadBalancerInboundNatRules::Union{ Nothing, Vector{InboundNatRule} } # loadBalancerInboundNatRules
