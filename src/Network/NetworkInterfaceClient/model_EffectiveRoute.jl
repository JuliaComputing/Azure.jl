...
type EffectiveRoute <: SwaggerModel
    name::Nullable{ String } # name
    source::Nullable{ String } # source
    state::Nullable{ String } # state
    addressPrefix::Nullable{ Vector{String} } # addressPrefix
    nextHopIpAddress::Nullable{ Vector{String} } # nextHopIpAddress
