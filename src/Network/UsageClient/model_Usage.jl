...
mutable struct Usage <: SwaggerModel
    ...
    currentValue::Any # spec type: Union{ Nothing, Int64 } # spec name: currentValue
    limit::Any # spec type: Union{ Nothing, Int64 } # spec name: limit
    name::Any # spec type: Union{ Nothing, UsageName } # spec name: name

    function Usage(;id=nothing, unit=nothing, currentValue=nothing, limit=nothing, name=nothing)
        o = new()
...
const _property_map_Usage = Dict{Symbol,Symbol}(Symbol("id")=>Symbol("id"), Symbol("unit")=>Symbol("unit"), Symbol("currentValue")=>Symbol("currentValue"), Symbol("limit")=>Symbol("limit"), Symbol("name")=>Symbol("name"))
