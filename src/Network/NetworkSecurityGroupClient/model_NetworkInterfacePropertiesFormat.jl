...
mutable struct NetworkInterfacePropertiesFormat <: SwaggerModel
    ...
    networkSecurityGroup::Any # spec type: Union{ Nothing, NetworkSecurityGroup2 } # spec name: networkSecurityGroup
    ...
    tapConfigurations::Any # spec type: Union{ Nothing, Vector{NetworkInterfaceTapConfiguration} } # spec name: tapConfigurations
    ...
    function NetworkInterfacePropertiesFormat(;virtualMachine=nothing, networkSecurityGroup=nothing, privateEndpoint=nothing, ipConfigurations=nothing, tapConfigurations=nothing, dnsSettings=nothing, macAddress=nothing, primary=nothing, enableAcceleratedNetworking=nothing, enableIPForwarding=nothing, hostedWorkloads=nothing, resourceGuid=nothing, provisioningState=nothing)
        ...
        validate_property(NetworkInterfacePropertiesFormat, Symbol("privateEndpoint"), privateEndpoint)
        ...
        validate_property(NetworkInterfacePropertiesFormat, Symbol("tapConfigurations"), tapConfigurations)
        ...
        validate_property(NetworkInterfacePropertiesFormat, Symbol("hostedWorkloads"), hostedWorkloads)
...
Swagger.property_type(::Type{ NetworkInterfacePropertiesFormat }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_NetworkInterfacePropertiesFormat[name]))}
