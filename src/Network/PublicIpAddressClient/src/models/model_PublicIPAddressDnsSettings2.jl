...
Base.@kwdef mutable struct PublicIPAddressDnsSettings2 <: OpenAPI.APIModel
    ...
    function PublicIPAddressDnsSettings2(domainNameLabel, domainNameLabelScope, fqdn, reverseFqdn, )
...
const _property_types_PublicIPAddressDnsSettings2 = Dict{Symbol,String}(Symbol("domainNameLabel")=>"String", Symbol("domainNameLabelScope")=>"String", Symbol("fqdn")=>"String", Symbol("reverseFqdn")=>"String", )
...
function OpenAPI.check_required(o::PublicIPAddressDnsSettings2)
    true
end

function OpenAPI.validate_properties(o::PublicIPAddressDnsSettings2)
    OpenAPI.validate_property(PublicIPAddressDnsSettings2, Symbol("domainNameLabel"), o.domainNameLabel)
    OpenAPI.validate_property(PublicIPAddressDnsSettings2, Symbol("domainNameLabelScope"), o.domainNameLabelScope)
    OpenAPI.validate_property(PublicIPAddressDnsSettings2, Symbol("fqdn"), o.fqdn)
    OpenAPI.validate_property(PublicIPAddressDnsSettings2, Symbol("reverseFqdn"), o.reverseFqdn)
end
...
function OpenAPI.validate_property(::Type{ PublicIPAddressDnsSettings2 }, name::Symbol, val)
    ...
    if name === Symbol("domainNameLabelScope")
        OpenAPI.validate_param(name, "PublicIPAddressDnsSettings2", :enum, val, ["TenantReuse", "SubscriptionReuse", "ResourceGroupReuse", "NoReuse"])
    end
