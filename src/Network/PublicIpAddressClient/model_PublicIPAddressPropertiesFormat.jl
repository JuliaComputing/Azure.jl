...
mutable struct PublicIPAddressPropertiesFormat <: SwaggerModel
    publicIPAllocationMethod::Union{ Nothing, String } # publicIPAllocationMethod
    publicIPAddressVersion::Union{ Nothing, String } # publicIPAddressVersion
    ipConfiguration::Union{ Nothing, IPConfiguration } # ipConfiguration
    dnsSettings::Union{ Nothing, PublicIPAddressDnsSettings } # dnsSettings
