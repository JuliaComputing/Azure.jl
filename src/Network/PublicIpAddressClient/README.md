...
*PublicIPAddressesApi* | [**public_i_p_addresses_ddos_protection_status**](docs/PublicIPAddressesApi.md#public_i_p_addresses_ddos_protection_status)<br/>**POST** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/publicIPAddresses/{publicIpAddressName}/ddosProtectionStatus<br/>
