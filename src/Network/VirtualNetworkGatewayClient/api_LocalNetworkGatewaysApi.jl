...
immutable LocalNetworkGatewaysApi <: SwaggerApi
...
function localNetworkGatewaysDelete(_api::LocalNetworkGatewaysApi, resourceGroupName::String, localNetworkGatewayName::String, api_version::String, subscriptionId::String; _mediaType=nothing)
    ...
    _ctx = Swagger.Ctx(_api.client, "DELETE", Void, "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}", ["azure_auth"])
    Swagger.set_param(_ctx.path, "resourceGroupName", resourceGroupName)  # type String
    Swagger.set_param(_ctx.path, "localNetworkGatewayName", localNetworkGatewayName)  # type String
    Swagger.set_param(_ctx.path, "subscriptionId", subscriptionId)  # type String
    Swagger.set_param(_ctx.query, "api-version", api_version)  # type String
