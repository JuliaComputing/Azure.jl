...
type IpsecPolicy <: SwaggerModel
    saLifeTimeSeconds::Nullable{ Int32 } # saLifeTimeSeconds
    saDataSizeKilobytes::Nullable{ Int32 } # saDataSizeKilobytes
    ipsecEncryption::Nullable{ String } # ipsecEncryption
    ipsecIntegrity::Nullable{ String } # ipsecIntegrity
    ikeEncryption::Nullable{ String } # ikeEncryption
    ikeIntegrity::Nullable{ String } # ikeIntegrity
    dhGroup::Nullable{ String } # dhGroup
    pfsGroup::Nullable{ String } # pfsGroup
...
function check_required(o::IpsecPolicy)
    isnull(o.saLifeTimeSeconds) && (return false)
    isnull(o.saDataSizeKilobytes) && (return false)
    true
end
