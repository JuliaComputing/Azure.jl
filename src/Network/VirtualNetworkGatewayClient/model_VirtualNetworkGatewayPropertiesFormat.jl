...
type VirtualNetworkGatewayPropertiesFormat <: SwaggerModel
    ipConfigurations::Nullable{ Vector{VirtualNetworkGatewayIPConfiguration} } # ipConfigurations
    gatewayType::Nullable{ String } # gatewayType
    vpnType::Nullable{ String } # vpnType
    enableBgp::Nullable{ Bool } # enableBgp
    activeActive::Nullable{ Bool } # activeActive
    gatewayDefaultSite::Nullable{ SubResource } # gatewayDefaultSite
    sku::Nullable{ VirtualNetworkGatewaySku } # sku
    vpnClientConfiguration::Nullable{ VpnClientConfiguration } # vpnClientConfiguration
