...
Swagger.property_type(::Type{ ApplicationGatewayFirewallDisabledRuleGroup }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ApplicationGatewayFirewallDisabledRuleGroup[name]))}
