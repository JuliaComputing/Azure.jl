...
Properties of the subnet.
    ...
    - applicationGatewayIPConfigurations::Vector{ApplicationGatewayIPConfiguration2} : Application gateway IP configurations of virtual network resource.
...
Base.@kwdef mutable struct SubnetPropertiesFormat <: OpenAPI.APIModel
    ...
    applicationGatewayIPConfigurations::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{ApplicationGatewayIPConfiguration2} }
