...
function OpenAPI.check_required(o::ApplicationGatewayPathRule)
    true
end

function OpenAPI.validate_properties(o::ApplicationGatewayPathRule)
    OpenAPI.validate_property(ApplicationGatewayPathRule, Symbol("properties"), o.properties)
    OpenAPI.validate_property(ApplicationGatewayPathRule, Symbol("name"), o.name)
    OpenAPI.validate_property(ApplicationGatewayPathRule, Symbol("etag"), o.etag)
    OpenAPI.validate_property(ApplicationGatewayPathRule, Symbol("type"), o.type)
    OpenAPI.validate_property(ApplicationGatewayPathRule, Symbol("id"), o.id)
end
