...
Properties of IP configuration.
    ...
    - applicationGatewayBackendAddressPools::Vector{ApplicationGatewayBackendAddressPool2} : The reference to ApplicationGatewayBackendAddressPool resource.
...
Base.@kwdef mutable struct NetworkInterfaceIPConfigurationPropertiesFormat <: OpenAPI.APIModel
    ...
    applicationGatewayBackendAddressPools::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{ApplicationGatewayBackendAddressPool2} }
