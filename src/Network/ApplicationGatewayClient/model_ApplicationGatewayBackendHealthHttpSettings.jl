...
type ApplicationGatewayBackendHealthHttpSettings <: SwaggerModel
    backendHttpSettings::Nullable{ ApplicationGatewayBackendHttpSettings } # backendHttpSettings
    servers::Nullable{ Vector{ApplicationGatewayBackendHealthServer} } # servers
