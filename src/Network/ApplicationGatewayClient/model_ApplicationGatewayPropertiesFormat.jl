...
mutable struct ApplicationGatewayPropertiesFormat <: SwaggerModel
    sku::Union{ Nothing, ApplicationGatewaySku } # sku
    sslPolicy::Union{ Nothing, ApplicationGatewaySslPolicy } # sslPolicy
    operationalState::Union{ Nothing, String } # operationalState
    gatewayIPConfigurations::Union{ Nothing, Vector{ApplicationGatewayIPConfiguration} } # gatewayIPConfigurations
    authenticationCertificates::Union{ Nothing, Vector{ApplicationGatewayAuthenticationCertificate} } # authenticationCertificates
    sslCertificates::Union{ Nothing, Vector{ApplicationGatewaySslCertificate} } # sslCertificates
    frontendIPConfigurations::Union{ Nothing, Vector{ApplicationGatewayFrontendIPConfiguration} } # frontendIPConfigurations
    frontendPorts::Union{ Nothing, Vector{ApplicationGatewayFrontendPort} } # frontendPorts
    probes::Union{ Nothing, Vector{ApplicationGatewayProbe} } # probes
    backendAddressPools::Union{ Nothing, Vector{ApplicationGatewayBackendAddressPool} } # backendAddressPools
    backendHttpSettingsCollection::Union{ Nothing, Vector{ApplicationGatewayBackendHttpSettings} } # backendHttpSettingsCollection
    httpListeners::Union{ Nothing, Vector{ApplicationGatewayHttpListener} } # httpListeners
    urlPathMaps::Union{ Nothing, Vector{ApplicationGatewayUrlPathMap} } # urlPathMaps
    requestRoutingRules::Union{ Nothing, Vector{ApplicationGatewayRequestRoutingRule} } # requestRoutingRules
    webApplicationFirewallConfiguration::Union{ Nothing, ApplicationGatewayWebApplicationFirewallConfiguration } # webApplicationFirewallConfiguration
