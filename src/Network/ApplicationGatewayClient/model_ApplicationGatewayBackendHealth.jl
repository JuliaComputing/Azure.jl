...
Swagger.property_type(::Type{ ApplicationGatewayBackendHealth }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ApplicationGatewayBackendHealth[name]))}
