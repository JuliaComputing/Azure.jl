...
mutable struct ApplicationGatewaySslCertificatePropertiesFormat <: SwaggerModel
    ...
    function ApplicationGatewaySslCertificatePropertiesFormat(;data=nothing, password=nothing, publicCertData=nothing, keyVaultSecretId=nothing, provisioningState=nothing)
        o = new()
        ...
        validate_property(ApplicationGatewaySslCertificatePropertiesFormat, Symbol("keyVaultSecretId"), keyVaultSecretId)
...
const _property_map_ApplicationGatewaySslCertificatePropertiesFormat = Dict{Symbol,Symbol}(Symbol("data")=>Symbol("data"), Symbol("password")=>Symbol("password"), Symbol("publicCertData")=>Symbol("publicCertData"), Symbol("keyVaultSecretId")=>Symbol("keyVaultSecretId"), Symbol("provisioningState")=>Symbol("provisioningState"))
...
Swagger.property_type(::Type{ ApplicationGatewaySslCertificatePropertiesFormat }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ApplicationGatewaySslCertificatePropertiesFormat[name]))}
