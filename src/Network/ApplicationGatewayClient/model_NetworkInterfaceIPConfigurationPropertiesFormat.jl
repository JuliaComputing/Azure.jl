...
mutable struct NetworkInterfaceIPConfigurationPropertiesFormat <: SwaggerModel
    ...
    applicationGatewayBackendAddressPools::Any # spec type: Union{ Nothing, Vector{ApplicationGatewayBackendAddressPool2} } # spec name: applicationGatewayBackendAddressPools
