...
mutable struct ApplicationGatewayUrlPathMapPropertiesFormat <: SwaggerModel
    ...
    defaultRewriteRuleSet::Any # spec type: Union{ Nothing, SubResource } # spec name: defaultRewriteRuleSet
    defaultRedirectConfiguration::Any # spec type: Union{ Nothing, SubResource } # spec name: defaultRedirectConfiguration
    pathRules::Any # spec type: Union{ Nothing, Vector{ApplicationGatewayPathRule} } # spec name: pathRules
    provisioningState::Any # spec type: Union{ Nothing, ProvisioningState } # spec name: provisioningState

    function ApplicationGatewayUrlPathMapPropertiesFormat(;defaultBackendAddressPool=nothing, defaultBackendHttpSettings=nothing, defaultRewriteRuleSet=nothing, defaultRedirectConfiguration=nothing, pathRules=nothing, provisioningState=nothing)
        o = new()
        ...
        validate_property(ApplicationGatewayUrlPathMapPropertiesFormat, Symbol("defaultRewriteRuleSet"), defaultRewriteRuleSet)
        setfield!(o, Symbol("defaultRewriteRuleSet"), defaultRewriteRuleSet)
        validate_property(ApplicationGatewayUrlPathMapPropertiesFormat, Symbol("defaultRedirectConfiguration"), defaultRedirectConfiguration)
        setfield!(o, Symbol("defaultRedirectConfiguration"), defaultRedirectConfiguration)
...
const _property_map_ApplicationGatewayUrlPathMapPropertiesFormat = Dict{Symbol,Symbol}(Symbol("defaultBackendAddressPool")=>Symbol("defaultBackendAddressPool"), Symbol("defaultBackendHttpSettings")=>Symbol("defaultBackendHttpSettings"), Symbol("defaultRewriteRuleSet")=>Symbol("defaultRewriteRuleSet"), Symbol("defaultRedirectConfiguration")=>Symbol("defaultRedirectConfiguration"), Symbol("pathRules")=>Symbol("pathRules"), Symbol("provisioningState")=>Symbol("provisioningState"))
...
Swagger.property_type(::Type{ ApplicationGatewayUrlPathMapPropertiesFormat }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ApplicationGatewayUrlPathMapPropertiesFormat[name]))}
