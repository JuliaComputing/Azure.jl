...
**applicationGatewayIPConfigurations** | [**Vector{ApplicationGatewayIPConfiguration2}**](ApplicationGatewayIPConfiguration2.md) | Application gateway IP configurations of virtual network resource. | [optional] [default to nothing]
