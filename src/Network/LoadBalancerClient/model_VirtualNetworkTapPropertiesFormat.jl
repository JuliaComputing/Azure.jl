...
mutable struct VirtualNetworkTapPropertiesFormat <: SwaggerModel
    networkInterfaceTapConfigurations::Any # spec type: Union{ Nothing, Vector{NetworkInterfaceTapConfiguration} } # spec name: networkInterfaceTapConfigurations
    resourceGuid::Any # spec type: Union{ Nothing, String } # spec name: resourceGuid
    provisioningState::Any # spec type: Union{ Nothing, ProvisioningState } # spec name: provisioningState
    destinationNetworkInterfaceIPConfiguration::Any # spec type: Union{ Nothing, NetworkInterfaceIPConfiguration } # spec name: destinationNetworkInterfaceIPConfiguration
    destinationLoadBalancerFrontEndIPConfiguration::Any # spec type: Union{ Nothing, FrontendIPConfiguration2 } # spec name: destinationLoadBalancerFrontEndIPConfiguration
