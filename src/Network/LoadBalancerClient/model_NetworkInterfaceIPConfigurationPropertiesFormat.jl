...
mutable struct NetworkInterfaceIPConfigurationPropertiesFormat <: SwaggerModel
    ...
    loadBalancerBackendAddressPools::Any # spec type: Union{ Nothing, Vector{BackendAddressPool2} } # spec name: loadBalancerBackendAddressPools
    loadBalancerInboundNatRules::Any # spec type: Union{ Nothing, Vector{InboundNatRule2} } # spec name: loadBalancerInboundNatRules
