...
Properties of the private link service.
    ...
    - loadBalancerFrontendIpConfigurations::Vector{FrontendIPConfiguration2} : An array of references to the load balancer IP configurations.
    ...
    - networkInterfaces::Vector{NetworkInterface} : An array of references to the network interfaces created for this private link service.
...
Base.@kwdef mutable struct PrivateLinkServiceProperties <: OpenAPI.APIModel
    loadBalancerFrontendIpConfigurations::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{FrontendIPConfiguration2} }
