...
Properties of IP configuration.
    ...
    - loadBalancerBackendAddressPools::Vector{BackendAddressPool2} : The reference to LoadBalancerBackendAddressPool resource.
    - loadBalancerInboundNatRules::Vector{InboundNatRule2} : A list of references of LoadBalancerInboundNatRules.
...
Base.@kwdef mutable struct NetworkInterfaceIPConfigurationPropertiesFormat <: OpenAPI.APIModel
    ...
    loadBalancerBackendAddressPools::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{BackendAddressPool2} }
    loadBalancerInboundNatRules::Union{Nothing, Vector} = nothing # spec type: Union{ Nothing, Vector{InboundNatRule2} }
