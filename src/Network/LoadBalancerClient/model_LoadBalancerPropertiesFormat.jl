...
mutable struct LoadBalancerPropertiesFormat <: SwaggerModel
    frontendIPConfigurations::Union{ Nothing, Vector{FrontendIPConfiguration} } # frontendIPConfigurations
    backendAddressPools::Union{ Nothing, Vector{BackendAddressPool} } # backendAddressPools
    loadBalancingRules::Union{ Nothing, Vector{LoadBalancingRule} } # loadBalancingRules
    probes::Union{ Nothing, Vector{Probe} } # probes
    inboundNatRules::Union{ Nothing, Vector{InboundNatRule} } # inboundNatRules
    inboundNatPools::Union{ Nothing, Vector{InboundNatPool} } # inboundNatPools
    outboundNatRules::Union{ Nothing, Vector{OutboundNatRule} } # outboundNatRules
