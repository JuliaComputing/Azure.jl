...
"""
function _swaggerinternal_expressRouteServiceProvidersList(_api::ExpressRouteServiceProvidersApi, api_version::String, subscriptionId::String; _mediaType=nothing)
...
function expressRouteServiceProvidersList(_api::ExpressRouteServiceProvidersApi, api_version::String, subscriptionId::String; _mediaType=nothing)
    _ctx = _swaggerinternal_expressRouteServiceProvidersList(_api, api_version, subscriptionId; _mediaType=_mediaType)
    Swagger.exec(_ctx)
end

function expressRouteServiceProvidersList(_api::ExpressRouteServiceProvidersApi, response_stream::Channel, api_version::String, subscriptionId::String; _mediaType=nothing)
    _ctx = _swaggerinternal_expressRouteServiceProvidersList(_api, api_version, subscriptionId; _mediaType=_mediaType)
