...
struct ExpressRouteCircuitArpTableApi <: SwaggerApi
...
"""
function _swaggerinternal_expressRouteCircuitsListArpTable(_api::ExpressRouteCircuitArpTableApi, resourceGroupName::String, circuitName::String, peeringName::String, devicePath::String, api_version::String, subscriptionId::String; _mediaType=nothing)
...
function expressRouteCircuitsListArpTable(_api::ExpressRouteCircuitArpTableApi, resourceGroupName::String, circuitName::String, peeringName::String, devicePath::String, api_version::String, subscriptionId::String; _mediaType=nothing)
    _ctx = _swaggerinternal_expressRouteCircuitsListArpTable(_api, resourceGroupName, circuitName, peeringName, devicePath, api_version, subscriptionId; _mediaType=_mediaType)
    Swagger.exec(_ctx)
end

function expressRouteCircuitsListArpTable(_api::ExpressRouteCircuitArpTableApi, response_stream::Channel, resourceGroupName::String, circuitName::String, peeringName::String, devicePath::String, api_version::String, subscriptionId::String; _mediaType=nothing)
    _ctx = _swaggerinternal_expressRouteCircuitsListArpTable(_api, resourceGroupName, circuitName, peeringName, devicePath, api_version, subscriptionId; _mediaType=_mediaType)
